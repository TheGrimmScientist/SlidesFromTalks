...
# Code fixed and extended by Allen Grimm, 2014.
...
class dtree:
	...
	def read_data(self,filename):
		fid = open(filename,"r")
		data = []
		# the old data-read part didn't work for me.
		# d = []
	...
	def make_tree(self,data,classes,featureNames,maxlevel=-1,level=0,forest=0,verbose=False):
		...
		if nData==0 or nFeatures == 0 or (maxlevel>=0 and level>maxlevel):
			...
			if verbose == True:
				print "level",level
				print "Info gain per feature:",gain
				print "Chosen feature:",bestFeature
				print 
			...
			for value in values:
				...
				subtree = self.make_tree(newData,newClasses,newNames,maxlevel,level+1,forest,verbose=verbose)
